...
/*
  Hardware Test for Event Timer
    ...
    Basic hardware test using Photon 2 in the RFID Station hardware.

    This code displays some stuff on the LCD display and blinks the LEDs 
    in order to demonstrate that the pin mappings are correct.

    Bob Glicksman; 8/24/25
